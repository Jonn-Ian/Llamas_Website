                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">Cool Services</h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5">Llama Accounting template comes with total 8 HTML pages provided by Tooplate website.</p>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="product.php" class="btn custom-btn">Explore Services</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content mt-2" id="pills-tabContent">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Llamas Accounting templates comes with <a href="sign-in.php">sign in</a> / <a href="sign-up.php">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <div class="ratio ratio-16x9">
                                                <iframe src="https://www.youtube-nocookie.com/embed/uLFtmJlzKvE?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Over Eight years in business, We’ve had the chance to work on a variety of projects, with companies</p>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                <h4 class="mb-3">What we can help you?</h4>
            ...
            <section class="featured-product section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <a href="products.php" class="view-all">View All Services</a>
                        </div>
